...
<form action="{{ route('profile.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class=" mb-3">
        ...
        <input type="text" name="name" id="" class="form-control" placeholder="votre nom complaite" aria-describedby="helpId" value="{{ old('name') }}">
            @error('name')
      ...
      <div class="mb-3">
          ...
          <input type="email" name="email" id="" class="form-control" placeholder="votre email" aria-describedby="helpId" value="{{ old('email') }}">
            @error('email')
            <strong style="color: red">{{ $message }}</strong>
            @enderror
      </div>
      ...
      <div class="mb-3">
          ...
          <textarea class="form-control" name="bio" id="exampleFormControlTextarea1" rows="3" placeholder="script">{{ old('bio') }}</textarea>
            @error('bio')
            <strong style="color: red">{{ $message }}</strong>
            @enderror
      </div>
